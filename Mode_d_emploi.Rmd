...
1. Téléchargez la dernière version de *scdoc* sur Github<i class="icon-github-circled"></i> 
   (<https://github.com/larmarange/scdoc/archive/master.zip>).
...
Il est possible d'écrire des équations^[Les équations seront transformées 
au format MathML qui n'est pas correctement interprété par tous les navigateurs.
La libraririe MathJax sera ajoutée dans une prochaine version.]
au format LaTeX.
