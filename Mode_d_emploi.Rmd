...
On peut ajouter une référence [@gabadinho:2011analyzing] au texte. Pour plus de
détails sur la syntaxe, voir <http://johnmacfarlane.net/pandoc/README.html#citations>.

Il faut soit que les sources bibliographiques soient ajouter au format YAML dans
